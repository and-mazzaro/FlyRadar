...
const IATA_GUIDE = [
  ...
  { group: 'North America', airports: [
    { code: 'JFK / LGA / EWR', city: 'New York' },
    { code: 'LAX', city: 'Los Angeles' },
    { code: 'MIA', city: 'Miami' },
    { code: 'ORD', city: 'Chicago' },
    { code: 'SFO', city: 'San Francisco' },
    { code: 'BOS', city: 'Boston' },
    { code: 'ATL / DFW', city: 'Atlanta / Dallas' },
    { code: 'LAS / SEA / DEN / PHX', city: 'Las Vegas / Seattle / Denver / Phoenix' },
    { code: 'IAD / MCO', city: 'Washington / Orlando' },
    { code: 'YYZ / YUL / YVR / YYC', city: 'Canada' },
    { code: 'MEX / CUN / GDL', city: 'Messico' },
  ]},
  { group: 'South America & Caraibi', airports: [
    { code: 'GRU / GIG', city: 'Brasile' },
    { code: 'EZE', city: 'Buenos Aires' },
    { code: 'BOG / LIM / SCL', city: 'Colombia / Perù / Cile' },
    { code: 'MVD / PTY / SJO / UIO', city: 'Uruguay / Panama / Costa Rica / Ecuador' },
    { code: 'HAV / PUJ / SDQ / MBJ / NAS', city: 'Caraibi' },
  ]},
  { group: 'Middle East & Turkey', airports: [
    { code: 'DXB / AUH / SHJ', city: 'Emirati Arabi Uniti' },
    { code: 'DOH', city: 'Doha' },
    { code: 'IST / SAW / ADB / AYT / ESB', city: 'Turchia' },
    { code: 'TLV', city: 'Tel Aviv' },
    { code: 'AMM / BEY / KWI / MCT', city: 'Giordania / Libano / Kuwait / Oman' },
    { code: 'JED / RUH / BAH', city: 'Arabia Saudita / Bahrein' },
  ]},
  { group: 'Asia & Oceania', airports: [
    { code: 'NRT / HND', city: 'Tokyo' },
    { code: 'PEK / PVG / CAN', city: 'Cina' },
    { code: 'ICN / TPE', city: 'Corea / Taiwan' },
    { code: 'BKK / SGN / HAN', city: 'Thailandia / Vietnam' },
    { code: 'SIN / KUL / MNL / CGK', city: 'Southeast Asia' },
    { code: 'HKG', city: 'Hong Kong' },
    { code: 'DEL / BOM / BLR / CCU / CMB', city: 'India / Sri Lanka' },
    { code: 'DPS / MLE', city: 'Bali / Maldive' },
    { code: 'SYD / MEL / PER / BNE / AKL', city: 'Australia / Nuova Zelanda' },
  ]},
  { group: 'Africa', airports: [
    { code: 'CAI / SSH / HRG', city: 'Egitto' },
    { code: 'RAK / CMN / AGA / FEZ', city: 'Marocco' },
    { code: 'TUN / DJE / ALG', city: 'Tunisia / Algeria' },
    { code: 'NBO / JNB / CPT / ZNZ', city: 'Africa orientale / meridionale' },
    { code: 'ADD / MRU / SEZ / LOS / ACC', city: 'Etiopia / Mauritius / Seychelles / Nigeria / Ghana' },
  ]},
];
